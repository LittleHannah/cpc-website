  ...
  <div>
    <div style="max-width: 1200px; padding: 0 10px 20px">
      ...
      <div class="card-content">
        ...
        <!--        新加图的注解-->
        <p>
          NGx plot showing the assembly contiguity of the core assembly of 58 CPC core samples. T2T-CHM13 and the contigs of GRCh38 (N-masked) are included for comparison.
        </p>
        <h2>New Findings</h2>
        <p>
